...
MODEL.pretraining.block_size = 512
MODEL.pretraining.mlm_prob = 0.15  # bert: 15%

MODEL.pretraining.batch_size =  8  # bert: 256
MODEL.pretraining.gradient_accumulation_steps = 4 #256 // MODEL.pretraining.batch_size
